...
const GAME_PICKER_STR = {
  ...
  de: { title: 'Spiel wählen', snakeName: '🐍 KI-Schlange', snakeDesc: 'Klassiker — sammle die richtigen Buchstaben', pfName: '🤖 Circuit Runner', pfDesc: 'Rennen, springen, ausweichen, Roboter bauen', raceName: '🏎️ Circuit Racer', raceDesc: 'Spur wechseln, Verkehr ausweichen, Auto bauen', exit: 'Verlassen' },
  es: { title: 'Elige un juego', snakeName: '🐍 Serpiente IA', snakeDesc: 'Clásico — come las letras correctas', pfName: '🤖 Circuit Runner', pfDesc: 'Corre, salta, esquiva, construye tu robot', raceName: '🏎️ Circuit Racer', raceDesc: 'Cambia de carril, esquiva el tráfico, construye tu coche', exit: 'Salir' },
  fr: { title: 'Choisis un jeu', snakeName: '🐍 Serpent IA', snakeDesc: 'Classique — mange les bonnes lettres', pfName: '🤖 Circuit Runner', pfDesc: 'Cours, saute, esquive, construis ton robot', raceName: '🏎️ Circuit Racer', raceDesc: 'Change de voie, évite le trafic, construis ta voiture', exit: 'Quitter' },
  hi: { title: 'गेम चुनें', snakeName: '🐍 AI साँप', snakeDesc: 'क्लासिक — सही अक्षर खाओ', pfName: '🤖 Circuit Runner', pfDesc: 'दौड़ो, कूदो, बचो, अपना रोबोट बनाओ', raceName: '🏎️ Circuit Racer', raceDesc: 'लेन बदलो, ट्रैफ़िक से बचो, अपनी कार बनाओ', exit: 'बाहर जाएं' },
  id: { title: 'Pilih game', snakeName: '🐍 Ular AI', snakeDesc: 'Klasik — makan huruf yang benar', pfName: '🤖 Circuit Runner', pfDesc: 'Lari, lompat, hindari, bangun robotmu', raceName: '🏎️ Circuit Racer', raceDesc: 'Pindah jalur, hindari lalu lintas, bangun mobilmu', exit: 'Keluar' },
  pt: { title: 'Escolha um jogo', snakeName: '🐍 Cobra IA', snakeDesc: 'Clássico — coma as letras certas', pfName: '🤖 Circuit Runner', pfDesc: 'Corra, pule, desvie, construa seu robô', raceName: '🏎️ Circuit Racer', raceDesc: 'Mude de faixa, desvie do trânsito, construa seu carro', exit: 'Sair' },
  tr: { title: 'Oyun seç', snakeName: '🐍 AI Yılanı', snakeDesc: 'Klasik — doğru harfleri ye', pfName: '🤖 Circuit Runner', pfDesc: 'Koş, zıpla, kaç, robotunu inşa et', raceName: '🏎️ Circuit Racer', raceDesc: 'Şerit değiştir, trafikten kaç, arabanı inşa et', exit: 'Çıkış' },
  vi: { title: 'Chọn trò chơi', snakeName: '🐍 Rắn AI', snakeDesc: 'Cổ điển — ăn đúng chữ cái', pfName: '🤖 Circuit Runner', pfDesc: 'Chạy, nhảy, né tránh, xây dựng robot của bạn', raceName: '🏎️ Circuit Racer', raceDesc: 'Đổi làn, né tránh giao thông, xây dựng xe của bạn', exit: 'Thoát' },
};
