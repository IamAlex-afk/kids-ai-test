...
const CACHE = 'kat-2026-08e';
const PRECACHE = [
  './', './index.html', './ru.html', './de.html', './es.html',
  './fr.html', './hi.html', './id.html', './pt.html', './tr.html', './vi.html',
  './css/main.css',
  './js/core.js', './js/card.js', './js/snake.js', './js/platformer.js', './js/racing.js', './js/leaderboard.js', './js/companion.js', './js/names.js', './js/parents-faq.js',
